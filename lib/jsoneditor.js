	...
	// titles with explanation for the different types
	  ...
	  Node.prototype.showContextMenu = function (anchor, onClose) {
	    ...
	    if (this.parent && this.parent._hasChilds()) {
	      ...
	      if (this.field === 'value') {
				items.push ({
					text: 'Add parameter as value',
					title: 'Insert value',
					className: 'insert',
					click: function() {
						node._onInsertAfter('value', {"name":"","value":"","description":""});
						node._onRemove();
					}
				});
			}
	        else if (this.field === 'version') {
			items.push({
	          text: 'Add parameter',
	          title: 'Insert a new parameter',
	          className: 'append',
	          click: function () {
	            node._onInsertAfter('parameters', {"name":"","value":"","description":""});
	          }
	        });
	      }
		  else {
	      ...
	      items.push({
	        text: 'Add attribute',
	        title: 'Insert custom attribute (Ctrl+Ins)',
	        className: 'insert',
	        click: function () {
