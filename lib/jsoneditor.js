	  ...
	  Node.prototype.showContextMenu = function (anchor, onClose) {
	    ...
	    if (this.parent && this.parent._hasChilds()) {
	      ...
	      if (this.field === 'value') {
			items.push({
				...
				className: 'insert',
				click: function() {
					node._onInsertAfter('value', [{"name":"","description":"","value":""}]);
					node._onRemove();
				}
		    });
		  }
		  if (this.field === 'value' && this._hasChilds()) {
			items.push({
				text: 'Add parameter',
				title: 'Insert parameter',
				className: 'type-object',
				click: function() {
					node._nextNode()._onInsertAfter('', {"name":"","description":"","value":""});
				}
			});
		  }
	    if (this.field === 'version') {
			items.push ({
				...
				className: 'append',
				click: function() {
					node._onInsertAfter('parameters', [{"name":"","description":"","value":""}]);
				}
			});
		}
		if (this.field === 'parameters') {
			items.push({
				text: 'Add parameter',
		  ...
		  if ((this.parent.field !== 'Configuration')&&(this.field === 'name' || this.field === 'description' || this.field === 'version' || this.field === 'value')) {
			items.push({
	      ...
	      if (this.editable.field || this.field === 'parameters') {
	        items.push({
	          text: 'Remove',
